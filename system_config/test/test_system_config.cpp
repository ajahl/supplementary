...
//	Configuration* firstConf = sc->operator []("Globals");
//	cout << "RootPath: " << path << endl;
//	SystemConfig* secondConf = sc->getInstance();
//	cout << "Neue conf: " << secondConf->operator []("Test2")->getNodes("Test2", NULL).get()->back()->getName() << endl;
//	cout << "Neue conf: " << secondConf->operator []("Test")->getNodes("Test2", NULL).get()->back()->getName() << endl;

//	sc->collectConfigs();
//	cout << sc->operator []("Globals")->serialize() << endl;
...
//	shared_ptr<vector<ConfigNode*> > confNodes;
//	shared_ptr<vector<ConfigNode*> > confNodes2;
//	confNodes = firstConf->getNodes("root", NULL);
//	cout << "confNodes" << confNodes << endl;
////	confNodes2 = firstConf->getNodes("Globals.FootballField", NULL);
//	vector<ConfigNode*>::iterator iter2;
//	vector<ConfigNodePtr> *confChildren3;
//	vector<ConfigNodePtr>::iterator iter3;
